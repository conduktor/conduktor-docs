...
There are breaking changes introduced in Gateway 3.12 which affect Trust and Partner Zone applications. This means that running those applications will require running Gateway 3.12.
