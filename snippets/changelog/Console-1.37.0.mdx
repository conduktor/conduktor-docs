...
With the support for multi-cluster Gateway, all existing Partner Zones created prior to this version of Console are incompatible and cannot be migrated or updated to support the new capability. Existing Partner Zones will stop functioning after the upgrade if not recreated.
