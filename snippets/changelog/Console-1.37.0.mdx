...
The self-service experience has been improved with **updated terminology** for managing access requests. Ambiguous and inconsistent references to various terminology such as 'subscriptions', 'subscribing', 'access requests', 'sharing', 'requests', have been standardized throughout the application, placing emphasis on a single unified concept known as **access request**.
