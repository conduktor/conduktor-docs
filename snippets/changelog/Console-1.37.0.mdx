...
Starting from Console 1.37, Gateway 3.12 or later will be required for Trust and Partner Zone functionality. Existing deployments using Trust policies or Partner Zones must upgrade to Gateway 3.12.0 to maintain compatibility with this Console release.
