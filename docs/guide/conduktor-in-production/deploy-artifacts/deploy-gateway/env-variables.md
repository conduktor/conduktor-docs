...
|---------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Common properties**                                                           |                                                                                                                                                            |                                                                                                         |
| `GATEWAY_ADVERTISED_HOST`                                                       | The hostname returned in Gateway’s metadata for clients to connect to.                                                                                 | Your hostname                                                                                           |
| `GATEWAY_ROUTING_MECHANISM`                                                     | Defines the routing method: **`port` for port routing, `host` for SNI routing**.                                                                           | `port`                                                                                                  |
| `GATEWAY_PORT_START`                                                            | The first port that Gateway listens on.                                                                                                                     | `6969`                                                                                                  |
...
| `GATEWAY_BIND_HOST`                                                             | The network interface that Gateway binds to.                                                                                                                | `0.0.0.0`                                                                                               |
...
| `GATEWAY_ADVERTISED_SNI_PORT`                                                   | The port returned in Gateway’s metadata for clients to connect to when using SNI routing.                                                              | `GATEWAY_PORT_START`                                                                                    |
...
| `GATEWAY_ACL_ENABLED`                             | Enable/disable ACLs support on Gateway transparent virtual cluster (`passthrough`) only.                                                                                                                             | `false`                                                                                                 |
