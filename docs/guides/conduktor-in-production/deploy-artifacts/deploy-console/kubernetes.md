...
[See our readme for coding snippets](https://github.com/conduktor/conduktor-public-charts/blob/main/charts/console/README.md#snippets).

## Related resources

- [View resource reference](/guides/reference/console-reference)
