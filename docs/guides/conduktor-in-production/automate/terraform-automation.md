...
Self-service Application API Key permissions are **limited to the scope of the ApplicationInstance** for which they have been generated. [Find out more about Self-service](/guides/use-cases/self-service/index).
...
Short-lived user API Keys will be valid for the same duration as the configured [session lifetime](/guides/conduktor-in-production/admin/user-access/session-lifetime).
