...
![Service Accounts](/guides/service-accounts.png)
...
![Confluent Cloud provider settings](/guides/confluent-cloud-provider.png)
...
![Confluent Service ACLs](/guides/confluent-sa.png)

Additionally, you can **list** and **create API Keys** associated with a Confluent Cloud service account:

![Confluent API Keys](/guides/confluent-sa-api-keys.png)
...
![Aiven Service Account](/guides/aiven-provider-fields.png)
:::
...
![Aiven ACLs](/guides/aiven-acls.png)
