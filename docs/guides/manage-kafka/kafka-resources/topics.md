...
import CreateTopic from '/guides/topic-create.png';
...
![Produce accordion](/guides/produce-accordion.png)
...
![Global search](/guides/topic-global-filter.png)
...
![Export records from a topic](/guides/topic-export.png)
