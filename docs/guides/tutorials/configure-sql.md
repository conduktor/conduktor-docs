...
![Conduktor SQL](/guides/conduktor-sql.png)
...
![Conduktor SQL Indexing](/guides/conduktor-sql-index.png)
...
![Conduktor SQL Index Status](/guides/conduktor-sql-index-status.png)
