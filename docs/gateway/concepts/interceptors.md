...
Interceptors with different names but the same scope and priority are ordered based on the 'first come, first served' approach: the Interceptor that's added first will be executed first.
