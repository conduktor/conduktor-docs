...
| `GATEWAY_SUPER_USERS`                      | empty                                 | Coma-separated lister of service accounts that will be super users on the Gateway (**excluding Virtual Clusters**).<br/> Example: `alice,bob`.                                                                        |
