...
| `GATEWAY_USER_POOL_SERVICE_ACCOUNT_REQUIRED` | default to `false`                  | If true, verify the existence of user mapping when the user connects in Non-Delegated SASL/PLAIN mode. |
