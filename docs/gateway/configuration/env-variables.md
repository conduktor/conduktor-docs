...
| **Environment variable**                  | **Description**                                                         |
|-------------------------------------------|-------------------------------------------------------------------------|
| `GATEWAY_PRINCIPAL_RESOLVER`              | The principal resolver to use. Currently only supported is `CONFLUENT`. |
...
| `GATEWAY_CONFLUENT_CLOUD_CACHE_SIZE`      | The number of principals to cache.                                      |
| `GATEWAY_CONFLUENT_CLOUD_CACHE_EXPIRY_MS` | The cache expiry time in milliseconds.                                  |
