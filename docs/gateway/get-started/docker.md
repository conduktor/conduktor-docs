...
It should be deployed and managed in the best way for your organization and use case(s). This could be a single container, or more likely, multiple Gateway instances should be deployed and scaled to meet your needs. Our recommendation is to [deploy with Kuberenetes](/platform/get-started/installation/get-started/kubernetes).
