...
| ------------- | ------------------------- | ---------------- |
| [conduktor-gateway-3.9.0](https://github.com/conduktor/conduktor-public-charts/releases/tag/conduktor-gateway-3.9.0) | **3.9.0**, 3.8.1, 3.8.0, 3.7.1, 3.7.0, 3.6.1, 3.6.0, 3.5.0, 3.4.1, 3.4.0, 3.3.1, 3.3.0, 3.2.2, 3.2.1, 3.2.0, 3.1.1, 3.1.0 | 🔴 Gateway service accounts are now always required, when using PLAIN tokens <br/> 🔴 Gateway JWT signing key must always be set, when using PLAIN tokens |
