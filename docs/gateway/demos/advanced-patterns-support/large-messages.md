...
```
-rw-r--r--  1 jameswhite  staff    40M Nov 25 22:46 large-message.bin
...
```
Reading payloads from: /Users/jameswhite/Documents/Proxy/conduktor-proxy-2/functional-testing/target/2024.11.25-22:19:13/large-messages/large-message.bin
...
```
-rw-r--r--  1 jameswhite  staff  41943041 Nov 25 22:46 from-kafka.bin
-rw-r--r--  1 jameswhite  staff  41943041 Nov 25 22:46 large-message.bin
...
```
2024-11-25 22:46:22   40.0 MiB large-messages/e38c3deb-b490-4673-8e0f-4894718d2b50
...
[2024-11-25 22:46:31,743] ERROR Error processing message, terminating consumer process:  (kafka.tools.ConsoleConsumer$)
