...
- `spec.schemaRegistry.type` (optional) must be one of [`Confluent`, `Glue`] 
  - See [Schema Registry Properties](/platform/get-started/configuration/env-variables/#schema-registry-properties) for the detailed list of options
- `spec.kafkaFlavor.type` (optional) must be one of [`Confluent`, `Aiven`, `Gateway`] 
  - See [Kafka Flavor Properties](/platform/get-started/configuration/env-variables/#kafka-vendor-specific-properties) for the detailed list of options
