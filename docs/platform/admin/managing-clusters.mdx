...
To create a new cluster configuration, click on the "Create cluster" button in the top right-hand corner, then follow the instructions from the [Get Started](/platform/installation/get-started/cloud#configure-your-first-cluster/) section.
