...
| **`CDK_HTTP_PROXY_HOST`**         | Specify [proxy settings](./http-proxy-configuration.md) that Conduktor Platform should use to access the Internet | None                                                                                   | `1.10.0`      | latest        |
| **`CDK_HTTP_PROXY_PORT`**         | Specify [proxy settings](./http-proxy-configuration.md) that Conduktor Platform should use to access the Internet | `80`                                                                                   | `1.10.0`      | latest        |
| **`CDK_HTTP_NON_PROXY_HOSTS`**    | Specify [proxy settings](./http-proxy-configuration.md) that Conduktor Platform should use to access the Internet | None                                                                                   | `1.10.0`      | latest        |
| **`CDK_HTTP_PROXY_USERNAME`**     | Specify [proxy settings](./http-proxy-configuration.md) that Conduktor Platform should use to access the Internet | None                                                                                   | `1.10.0`      | latest        |
| **`CDK_HTTP_PROXY_PASSWORD`**     | Specify [proxy settings](./http-proxy-configuration.md) that Conduktor Platform should use to access the Internet | None                                                                                   | `1.10.0`      | latest        |
