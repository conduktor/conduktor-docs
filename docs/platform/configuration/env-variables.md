...
| `monitoring.storage.swift.userId`         | Swift storage user id                    | `CDK_MONITORING_STORAGE_SWIFT_USERID`        | true      | string | ∅       | `1.16.0` |
| `monitoring.storage.swift.password`       | Swift storage user password              | `CDK_MONITORING_STORAGE_SWIFT_PASSWORD`      | true      | string | ∅       | `1.16.0` |
| `monitoring.storage.swift.projectId`      | Swift storage project ID                 | `CDK_MONITORING_STORAGE_SWIFT_PROJECTID`     | true      | string | ∅       | `1.16.0` |
...
| `monitoring.storage.swift.containerName`  | Swift storage container name             | `CDK_MONITORING_STORAGE_SWIFT_CONTAINERNAME` | false     | string | ∅       | `1.16.0` |
