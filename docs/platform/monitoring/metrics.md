...
You will have access to some metrics without any additional configuration, but you should install the [agent](/platform/monitoring/agent-setup) to use Monitoring at full capacity.
