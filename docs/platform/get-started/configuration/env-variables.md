...
| `kafka_admin.describe_consumer_groups_batch_size`    | How many consumer groups to describe in a single query.                                                                                       | `CDK_KAFKAADMIN_DESCRIBECONSUMERGROUPSBATCHSIZE`   | false     | int  | `10000`           |
