...
- use **Conduktor Gateway 3.11.0** or later with the following configurations:
  ...
  - `GATEWAY_FEATURE_FLAGS_MANDATORY_VCLUSTER` set to `true`
    - Find out more about this [environment variable](https://docs.conduktor.io/gateway/configuration/env-variables/#connect-from-clients-to-gateway) and what [service account](https://docs.conduktor.io/gateway/concepts/service-accounts-authentication-authorization/#client-authentication-methods) needs to be setup. 
