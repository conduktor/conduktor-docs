...
The folder contains your configuration <strong>app.properties</strong> and its previous version <strong>app.properties.bak</strong> that can be used to recover your configuration if something happened (and app.properties is broken).
</InfoBox>
