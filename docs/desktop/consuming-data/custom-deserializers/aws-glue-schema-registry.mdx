...
We have also generated the fat jar for your convenience: <a href="../../assets/assets/glue-schema-registry-serde-1.1.10-with-dependancies.jar">glue-schema-registry-serde-1.1.10-with-dependancies.jar</a>
