...
<InfoBox type="info">
  You can further configure your deserializer as described in the Apicurio documentation:{' '}
  <a
    href="https://www.apicur.io/registry/docs/apicurio-registry/2.2.x/getting-started/assembly-using-kafka-client-serdes.html#registry-serdes-config-consumer_registry"
    target="_blank"
  >
    https://www.apicur.io/registry/docs/apicurio-registry/2.2.x/getting-started/assembly-using-kafka-client-serdes.html#registry-serdes-config-consumer_registry
  </a>
</InfoBox>
