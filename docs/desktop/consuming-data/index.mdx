...
<InfoBox type="success">
  Conduktor always displays data <strong>chronologically</strong>.
</InfoBox>
...
<InfoBox type="success">
  Pick "JSON" as your Value deserializer to see the <strong>formatted JSON</strong> in the details
