...
<InfoBox type="warning">
  By default, Conduktor uses <strong>"now \(latest\)"</strong>: it means that only new incoming data
...
<InfoBox type="info">
  If you set several filters, it's treated like an <strong>"AND"</strong>. We <strong>don't</strong>{' '}
...
<InfoBox type="danger">
Beware of <strong>"special"</strong> characters like <strong>"(" "{'{'}"</strong> or <strong>"."</strong>, they need to be <strong>"escaped"</strong>.

If you want to match <strong>"1.2.2"</strong> or <strong>"1.2.3"</strong>, use <strong>"1\.2\.[23]"</strong> and NOT <strong>"1.2.[23]"</strong> or you will match <strong>"**1**0**2**4**3**": "."</strong> means <strong>"any character"</strong>
