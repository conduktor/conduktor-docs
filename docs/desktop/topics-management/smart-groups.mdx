...
<InfoBox type="info">
  To create columns from parts, we must use <strong>Named Capturing Groups</strong>.<br />
  <a href="https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html" target="_blank">
