...
<InfoBox type="info">
In case you don't know what should be the values in the <strong>config.properties</strong> file, please contact your Kafka administrator.&#x20;
<br />
<strong>Note:</strong> these are the same properties you would use in your Kafka Java clients or applications.&#x20;
...
<InfoBox type="warning">
  Please make sure to put the <strong>full paths</strong> to your SSL certificates in your
...
<InfoBox type="warning">
  Please make sure to put the <strong>full paths</strong> to your SASL key files in your properties
