...
<InfoBox type="success">
  Just remember that Conduktor is running on <strong>your</strong> machine, running on{' '}
  <strong>your</strong> network, which may be _different_ from the network your Apache Kafka
