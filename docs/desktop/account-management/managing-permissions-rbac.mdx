...
<InfoBox type="info">This feature is available only for Enterprises.</InfoBox>
...
<InfoBox type="info">
  Removing the specific permission <strong>_Allow Users to Connect_</strong> will entirely prevent
