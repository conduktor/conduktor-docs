    ...
    },
    {
      ...
      items: [
        'conduktor-in-production/requirements',
        {
          ...
          link: { type: 'doc', id: 'conduktor-in-production/deploy-artifacts/overview' },
          items: [
            {
              type: 'autogenerated',
              dirName: 'conduktor-in-production/deploy-artifacts/deploy-gateway',
            },
            {
              type: 'autogenerated',
        ...
        'conduktor-in-production/manage-licenses/index',
        {
          type: 'category',
          label: 'Automate',
          link: { type: 'doc', id: 'conduktor-in-production/automate/automate-overview' },
          items: [
            {
              type: 'autogenerated',
