export const products = [
  {
    ...
    items: [
      ...
      [
        ...
        'https://docs.conduktor.io/platform/guides/self-service-quickstart/',
      ],
      ...
      [
        ...
        'https://docs.conduktor.io/gateway/category/traffic-control-policies/',
      ],
    ],
  },
  {
    ...
    items: [
      ...
      [
        'Data Masking',
        'https://docs.conduktor.io/gateway/interceptors/data-security/data-masking/',
      ],
      [
        'Dynamic Header Injection',
        'https://docs.conduktor.io/gateway/interceptors/data-security/dynamic-header-injection/',
      ],
    ],
  },
  {
...
export const useCases = [
  {
    ...
    items: [
      ...
      [
        'Configure Exportable Audit Log',
        'https://docs.conduktor.io/platform/guides/configure-audit-log-topic/',
      ],
      [
        'Configure Custom Deserializers',
        'https://docs.conduktor.io/platform/guides/custom-deserializers/',
      ],
