...
We support releases of our software for one calendar year after their release date (the release date being the date the version was first published). For the purposes of support, the specific software artefacts in scope for this policy are:
