...
import { DocsRating } from './Feedback.styled'
import Flex from '../../atoms/Flex'

export default function Feedback({ tiny = false }) {
    ...
    <Flex fullWidth align="center" justify="center">
      <DocsRating tiny={tiny}>
        ...
        {haveVoted ? (
          ...
          <Flex className="voters" gap={5} direction="row" align="center" justify="center">
            <svg
