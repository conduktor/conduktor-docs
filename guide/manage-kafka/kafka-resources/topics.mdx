...
import CreateTopic from '/guide/topic-create.png';
...
![Produce accordion](/guide/produce-accordion.png)
...
![Global search](/guide/topic-global-filter.png)
...
![Export records from a topic](/guide/topic-export.png)
