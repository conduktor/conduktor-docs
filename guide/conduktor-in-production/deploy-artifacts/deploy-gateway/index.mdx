...
<img 
  src="/images/gateway-to-kafka-security.png"
  alt="Gateway to Kafka security"
  width="200"
/>
...
The following steps are for setting up a partner virtual cluster manually. You can instead create a Partner Zone which supports multi-clusters that simplifies this process. Please see the [Create a Partner Zone](/guide/use-cases/third-party-data#create-a-partner-zone) guide.

The [Create Partner Zones using multi-cluster Gateway](/guide/tutorials/partner-zone-multi-cluster.mdx) tutorial page may additionally be helpful.
