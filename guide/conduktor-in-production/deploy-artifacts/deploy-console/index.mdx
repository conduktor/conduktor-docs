...
[Indexing](/guide/conduktor-concepts/indexing) is the internal process of Conduktor Console that fetches metadata from your Kafka cluster (e.g. topics, consumer groups, subjects).
