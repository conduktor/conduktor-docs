---
title: Deploying Cortex overview
---

To enable monitoring via Console, you can deploy and configure the `console-cortex` artifact or use your own compatible monitoring solution (since Console 1.38).
We support Cortex, Mimir and Prometheus as alternative solutions.
This guide focus on deploying the `console-cortex` artifact, which is a preconfigured Cortex that includes Prometheus and Alertmanager.
