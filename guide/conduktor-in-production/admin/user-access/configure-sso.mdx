...
<img 
  src="/images/external-groups-mapping.png" 
  alt="External groups mapping"
  width="500"
/>
...
1. Create a regular web application:
    <img 
      src="/images/auth0-create-app.png" 
      alt="Auth0 create app"
      width="300"
    />

1. Get the `client ID`, `client secret` and `domain`:
    <img 
      src="/images/auth0-client-id-secret-domain.png" 
      alt="Auth0 client Id secret domain"
      width="450"
    />
...
Make sure that a client secret will be generated - select `Confidential client`.
  ...
  <img 
    src="/images/cognito-app-client.png" 
