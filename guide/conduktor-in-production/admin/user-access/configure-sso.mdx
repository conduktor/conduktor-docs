...
![callback](/images/auth0-callback.png)
...
The scopes needed are `email`, `profile`, and `openid`. Optionally, you need [read only](`https://www.googleapis.com/auth/cloud-identity.groups.readonly`) for external group mapping.
...
![jumpcloud label](/images/jumpcloud-figure-4.png)
