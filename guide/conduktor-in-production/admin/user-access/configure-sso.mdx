...
1. Create a regular web application:
    <img src="/images/auth0-create-app.png" alt="Auth01"/>

1. Get the `client ID`, `client secret` and `domain`:
    <img src="/images/auth0-client-id-secret-domain.png" alt="Auth02" />
...
![](/images/azure-add-groups-claim.png)
...
import GoogleScopes from '/images/google-scopes.png';
...
import GoogleUserTypeInternal from '/images/google-user-type-internal.png';
...
import GoogleCreateClient from '/images/google-create-client.png';
...
import GoogleClientIdSecret from '/images/google-client-id-secret.png';
...
Now that your configuration is finished, you can [set up the mapping](/platform/get-started/configuration/user-authentication/external-group-sync/#create-an-external-group-mapping) between Google Groups and Console groups. 
...
![](/images/jumpcloud-figure-1.png)

- **Step 2**: Select a `Custom Application` as shown below.
![](/images/jumpcloud-figure-2.png)
...
import JumpCloudClientIdSecret from '/images/jumpcloud-figure-6.png';
...
![](/images/keycloak-client-config.png)
...
![](/images/keycloak-callback.png)

- **Step 4**: Get the `client secret` in the **Credentials** tab

![](/images/keycloak-client-secret.png)
...
import OktaCreateApp from '/images/okta-create-app.png';
...
import OktaCallbackUri from '/images/okta-callback-uri.png';
...
import OktaAssignments from '/images/okta-assignments.png';
...
import OktaClientIdSecret from '/images/okta-client-id-secret.png';
...
import OktaIssuer from '/images/okta-issuer.png';
