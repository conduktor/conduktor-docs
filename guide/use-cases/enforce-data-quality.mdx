...
1. Define the CEL expression for your Rule:
   ...
   - (Optional) Click **Show regex library** to access pre-built regex validation snippets. Click on any snippet to copy it to the clipboard, then paste it into your rule expression and customize as needed.
1. Click **Create**.
</Tab>
