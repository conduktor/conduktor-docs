...
The page displays four types of metrics: **Messages Evaluated Count** shows total messages checked against this policy. **Violations Count** shows total violations detected. **Violations Graph** is a bar chart showing past violations to help identify patterns and spikes. **Violations History** lists individual violation events showing when and where violations occurred.
