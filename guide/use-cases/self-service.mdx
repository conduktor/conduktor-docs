...
The Application Instance Details page summarizes all the information that relates to the Application Instance:
...
The Application Groups detail page features improved management capabilities:
- **Members tab**: managing group membership, making it easier to control who has access to application resources
- **Resources Tab**: Granular control over topic, consumer group, subject, and connector permissions for precise access management
- **External Group Mapping**: Application groups can also map to external groups for streamlined access management
