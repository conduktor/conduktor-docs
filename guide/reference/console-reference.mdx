...
```hcl
resource "conduktor_console_partner_zone_v2" "external-partner-zone" {
  name = "external-partner-zone"
  spec = {
    cluster      = "cdk-gateway"
    display_name = "External Partner Zone"
    description  = "An external partner to exchange data with."
    url          = "https://partner1.com"
    partner = {
      name  = "John Doe"
    ...
    authentication_mode = {
      type            = "PLAIN"
      service_account = "partner-external-partner"
    }
    topics = [
      {
        name          = "topic-a"
