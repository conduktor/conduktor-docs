...
- `spec.gatewayClusterId` has to be a valid Console cluster technical ID with the **Provider configured as *Gateway***.
- `spec.sourceClusterId` has to be a valid Console cluster technical ID where the cluster has to be defined under the Gateway defined by the `spec.gatewayClusterId`.
