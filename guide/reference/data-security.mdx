...
- [Encryption](#encryption-interceptors) on:
    - consume specific record fields or the entire payload
    - consume payload fields configured in specified schema
    - produce specific record fields or the entire payload
    - produce payload fields configured in specified schema
- Decrypt on consume any record fields encrypted by Gateway or the entire payload
