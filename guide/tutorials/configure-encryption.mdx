...
When encryption or decryption fails, you can configure client throttling to prevent overwhelming the system.
...
- If `throttleTimeMs = 0` (default): Throws regular exception without throttling
- Kafka clients automatically respect the throttle time in responses
