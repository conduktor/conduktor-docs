...
| `throttleTimeMs`                                                               | Integer                                          | 0               | When encryption fails, apply client throttling for the specified time in milliseconds. This helps prevent overwhelming the system during encryption failures. See more [details](#client-throttling)                                                                                                                                                   |
...
| `throttleTimeMs`         | Integer                                                           | 0                   | When decryption fails, apply client throttling for the specified time in milliseconds. This helps prevent overwhelming the system during decryption failures. See more [details](#client-throttling)                                                                                                                                                                                                                                                                          |
...
### How to Enable Client Throttling

Set the `throttleTimeMs` parameter in your encryption or decryption interceptor configuration:
...
- **System protection**: Automatically throttles problematic clients for the specified duration
- **Automatic handling**: Kafka clients automatically respect the throttle time in responses
- **Gradual recovery**: Helps prevent cascading failures by spacing out retry attempts
