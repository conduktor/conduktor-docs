...
Gateway supports the ability to connect to multiple underlying Kafka clusters. This allows you to create Partner Zones that can connect to different Kafka clusters, beyond just the main Gateway cluster.
