...
### Set up your Gateway with multi-cluster support
...
For a more in-depth look at creating a Partner Zone, check out the [Create a Partner Zone](/guide/use-cases/third-party-data#create-a-partner-zone) guide.
