...
By default, Console's audit log is stored in the connected PostgreSQL database but from [version 1.28.0](/changelog#console-1280), you can have Console send it to a Kafka topic.

In addition to the [export feature](/platform/navigation/console/topics/topic-consume/consume/#export-records-in-csv--json), you can easily integrate the Console audit log with your SIEM or log management system.
